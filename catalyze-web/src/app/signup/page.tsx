    ...
    return (
      <div className="-mx-4 -mt-4 min-h-screen flex flex-col items-center justify-center px-6 bg-gray-50">
        <div className="w-full max-w-sm text-center space-y-4">
          ...
          <Link href="/login" className="inline-block text-sm text-brand-600 font-medium hover:underline">
            Back to login
          </Link>
        </div>
      </div>
      ...
      <div className="w-full max-w-sm space-y-8">
        ...
        <div className="space-y-3">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-black rounded-xl text-sm font-medium text-white hover:bg-gray-900 transition-colors"
          >
