    ...
    <div className="space-y-6 pb-8">
      ...
      <section className="bg-white rounded-2xl border border-gray-100 p-5 space-y-3">
        ...
        <p className="text-sm text-gray-600 leading-relaxed">
          ...
          at Polytechnic University of the Philippines. It uses a camera-equipped litterbox device
          to automatically detect and analyze stool samples for health monitoring purposes.
        </p>
      </section>
      ...
      <section className="bg-white rounded-2xl border border-gray-100 p-5 space-y-3">
        ...
        <ul className="text-sm text-gray-600 leading-relaxed space-y-2 list-disc list-inside">
          ...
          <li>Detection data captured by your litterbox device (images, color analysis)</li>
      ...
      <section className="bg-white rounded-2xl border border-gray-100 p-5 space-y-3">
        ...
        <ul className="text-sm text-gray-600 leading-relaxed space-y-2 list-disc list-inside">
          ...
          <li>To display your cat&apos;s detection history and trends</li>
      ...
      <section className="bg-white rounded-2xl border border-gray-100 p-5 space-y-3">
        <h2 className="text-sm font-semibold text-gray-800">Not a Medical/Diagnostic Tool</h2>
        <p className="text-sm text-gray-600 leading-relaxed">
          Catalyze is not a veterinary diagnostic tool. Alerts are informational only.
          Always consult a licensed veterinarian for health concerns about your pet.
        </p>
      </section>
